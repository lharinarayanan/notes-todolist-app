<?php 
  ...
  $name = $email  = $address = $tel = $pass=$imagetmp=$file_size=$file_type="";
  $errors= array();
     ...
     if(!$conn)
    {
       ...
       /*if(!$dbsel)
     {
      ...
      //Password Encryption function
        ...
        $sql="INSERT INTO user(name,email,telephone,password) VALUES ('$name','$email','$tel','$hashed_password')";
    ...
    <head>
      <title>Registration Success</title>
        ...
        <body>
         ...
         <header>
          <h1 style="text-align: center;font-size: 40px; color: rgb(232,88,186); font-style: bold;text-shadow: 2px 2px 8px #FF0000;">DESI NOTES</h1></header>

         <div id="blink"><span>You have Registered Successfully.</span><br> Please login to your account.

         <button id="btn" onclick="location.href='sp_login.php'">Go to login Page</button>
         </div>

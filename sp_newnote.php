<?php
    ...
    $sql="INSERT INTO notes(name,title,note,notetime) VALUES ('$user_check','$title','$description',now())";
   ...
   <body>
      ...
      <div id="header"><h1 style="color: blue;font-size: 35px;font-weight: bold;">Create your Note</h1></div>
        <form method="post" autocomplete="off" id="abc">
                     <input name="Title" type="text" placeholder="Note title"><br>
                     <input name="todoDescription" type="text" placeholder="Note"><br>
